...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-uchicockUITests/IDMPhotoBrowser.framework"
  install_framework "Pods-uchicockUITests/M13Checkbox.framework"
  install_framework "Pods-uchicockUITests/MJRefresh.framework"
  install_framework "Pods-uchicockUITests/MYBlurIntroductionView.framework"
  ...
  install_framework "Pods-uchicockUITests/pop.framework"
