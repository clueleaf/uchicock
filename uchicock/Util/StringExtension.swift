...
//    }
    ...
    func isNewRecipe80() -> Bool {
        ...
        case "アティ－": return true
        case "アビー": return true
        ...
        case "スターズアンドストライプス": return true
        case "スティンガーロイヤル": return true
        case "スパニッシュタウン": return true
        case "スロージンフィズ": return true

        case "タキシード": return true
        case "タヒチアンゴールド": return true
        ...
        case "ブロンクステラス": return true
        case "ベネディクト": return true
        case "ヘミングウェイスペシャル": return true
        case "ベルベットハンマー": return true
        case "ベルモットハーフアンドハーフ": return true
