...
* 材料のカテゴリ分けができるようになりました！「アルコール」「ノンアルコール」「その他」の3つのカテゴリから目当ての材料を探しやすくなります。（自前で追加した材料は自動で「その他」カテゴリに入るので、「編集」にて適切なカテゴリに変更してください）
* テーマカラーを新たに5種類追加しました！さくっと変更できるので、気軽に変えてみてください
* 機能追加に伴い、タブメニューの順番を入れ替えました。最初は間違えてしまうかもしれませんが、すぐに慣れると思います
